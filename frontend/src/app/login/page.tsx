    ...
    >
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[#b3b3b3] font-medium text-center">Log in to Bellard.</p>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <Link 
            href="/signup"
            className="ml-2 text-white font-bold hover:underline hover:text-[#1ed760] transition-colors"
          >
            Sign up for Bellard
          </Link>
        </div>

        <p className="text-xs text-[#b3b3b3] text-center mt-8 pt-4 border-t border-[#282828]">
          By continuing, you agree to the Bellard Terms of Service and Privacy Policy.
        </p>
      </motion.div>
    </div>
  );
